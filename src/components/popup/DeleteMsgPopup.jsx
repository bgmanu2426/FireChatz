...
const DeleteMsgPopupComponent = (props) => {
            ...
            <div className="mt-10 mb-5">
                ...
                <div className="flex items-center justify-center gap-2 mt-10">
                    ...
                    <button
                        ...
                        className="border-[2px] border-white py-2 px-4 rounded-md text-sm text-whites hover:bg-white hover:text-black"
                    >
                        Cancel
                    </button>
                </div>
...
export default DeleteMsgPopupComponent;
